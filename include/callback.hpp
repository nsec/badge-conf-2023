...
namespace nsec {
// Basic callback class that captures a user argument and forwards invocation arguments.
// Since avr-g++ doesn't provide much in terms of metaprogramming support (e.g. std::forward,
// type_traits, etc.), this implementation is quite naive.
template <class FunctionReturnType, class... FunctionArgs>
class callback {
public:
